...
import { Database, Lock, ShieldCheck, Key, Server } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center bg-gradient-to-b from-medical-dark to-gray-900 p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <Database className="absolute text-blue-400/20 w-32 h-32 left-1/4 top-1/4 animate-pulse" />
        <Server className="absolute text-green-400/20 w-24 h-24 right-1/4 top-1/3 animate-pulse" />
